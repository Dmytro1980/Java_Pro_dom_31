package org.example.dao;
 /* Створити DAO-клас для зберігання операцій:
 додавання сутності, видалення сутності, зміни сутності,
 отримання всіх записів з БД, отримання конкретної сутності за ID.  */
...
public class StudentDao {
    ...
    // отримання конкретної сутності за ID.
    ...
    // отримання конкретної сутності за ім'ям.
